                        ...
                        @if (isset($leads))
                            @foreach ($leads as $lead)
                                <option value="{{ $lead->id }}"
                                    {{ !empty($contact) && $contact->lead_id == $lead->id ? 'selected' : '' }}>
                                    {{ $lead->name }}
                                </option>
                            @endforeach
                        @endif
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" name="contact_first_name" id="contact_first_name"
                        value="{{ !empty($contact) ? $contact->first_name : '' }}" required
                        class="form-control form-control-lg">
                </div>
                <div class="col">
                    <label for="contact_last_name">{{ __('Last name') }}</label>
                    <input type="text" name="contact_last_name" id="contact_last_name"
                        value="{{ !empty($contact) ? $contact->last_name : '' }}" class="form-control form-control-lg">
                </div>
            </div>
            <div class="row">
                <div class="col">
                ...
                <div class="col-10 col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="tel" name="contact_phone" id="contact_phone"
                            value="{{ !empty($contact) ? $contact->phone : '' }}" maxlength="15"
                            class="form-control form-control-lg">
                    </div>
                </div>
                <div class="col-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="contact_extension" id="contact_extension"
                            value="{{ old('contact_extension', $contact->extension ?? '') }}" maxlength="6"
                            class="form-control form-control-lg">
                    </div>
                </div>
            </div>
                ...
                <div class="col">
                    ...
                    <div class="input-group">
                        ...
                        <input type="url" name="contact_linkedin" id="contact_linkedin"
                            ...
                            class="form-control form-control-lg" onblur="updateNameFromLinkedIn(this.value)">
                    </div>
                </div>
                <div class="col">
